...
* {sunspot_index_queue}[http://rubygems.org/gems/sunspot_index_queue] &mdash; Provides asynchronous indexing to Solr for the sunspot gem. It uses a pluggable model for the backing queue and provides support for ActiveRecord and MongoDB out of the box.
