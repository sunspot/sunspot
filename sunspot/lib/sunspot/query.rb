%w(filter abstract_field_facet connective boost_query date_field_facet field_json_facet
   range_facet range_json_facet distinct_json_facet date_field_json_facet abstract_fulltext dismax join
