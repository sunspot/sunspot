describe 'keyword highlighting' do
  ...
  it 'should include highlights in the results' do
    @search_result.hits.first.highlights.length.should == 2
  end
  
  it 'should include highlights for all relevant fields' do
    @search_result.hits.first.highlights(:title).first.format.should == 'The quick brown <em>fox</em> jumped over the lazy dog'
